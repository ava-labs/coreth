...
var (
	...
	copyAndSet = func(c *ChainConfig, set func(*ChainConfig)) *ChainConfig {
		newConfig := *c
		set(&newConfig)
		return &newConfig
	}
	...
	TestFUpgradeChainConfig = copyAndSet(TestEtnaChainConfig, func(c *ChainConfig) {
		c.NetworkUpgrades.FUpgradeTimestamp = utils.NewUint64(0)
	})
)
