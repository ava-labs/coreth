...
//
//	mockgen -package=precompileconfig -destination=precompile/precompileconfig/mocks.go -copyright_file=license_header github.com/ava-labs/coreth/precompile/precompileconfig Predicater,Config,ChainConfig,Accepter
//
