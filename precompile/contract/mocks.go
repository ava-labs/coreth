...
//
//	mockgen -package=contract -destination=precompile/contract/mocks.go -copyright_file=license_header github.com/ava-labs/coreth/precompile/contract BlockContext,AccessibleState,StateDB
//
