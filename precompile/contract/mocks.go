...
// Source: github.com/ava-labs/coreth/precompile/contract (interfaces: AccessibleState,StateDB,BlockContext,Configurator)
//
// Generated by this command:
//
//	mockgen -package=contract -destination=mocks.go . AccessibleState,StateDB,BlockContext,Configurator
//
...
func (mr *MockConfiguratorMockRecorder) Configure(chainConfig, precompileconfig, state, blockContext any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
