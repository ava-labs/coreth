...
func TestEstimateGas(t *testing.T) {
	...
	api := NewBlockChainAPI(newTestBackend(t, genBlocks, genesis, dummy.NewETHFaker(), func(i int, b *core.BlockGen) {
...
func TestRPCGetBlockOrHeader(t *testing.T) {
	...
	backend := newTestBackend(t, genBlocks, genesis, dummy.NewETHFaker(), func(i int, b *core.BlockGen) {
		// Transfer from account[0] to account[1]
		//    value: 1000 wei
		//    fee:   0 wei
