...
func ExampleGenerateChain() {
	...
	chain, _, err := GenerateChain(gspec.Config, genesis, dummy.NewFaker(), genDb, 3, 10, func(i int, gen *BlockGen) {
		switch i {
		case 0:
	...
	blockchain, _ := NewBlockChain(db, DefaultCacheConfigWithScheme(rawdb.HashScheme), gspec, dummy.NewFaker(), vm.Config{}, common.Hash{}, false)
