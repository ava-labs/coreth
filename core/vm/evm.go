...
func (evm *EVM) isProhibitedWithTimestamp(addr common.Address) error {
	...
	switch {
	case evm.chainRules.IsApricotPhase7: // If the hard fork has activated, return nil
		return nil
	case evm.chainRules.IsApricotPhasePre7: // If we are in the soft fork, return the soft error
