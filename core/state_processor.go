...
func ApplyTransaction(config *params.ChainConfig, bc ChainContext, _ *common.Address, gp *GasPool,
	statedb *state.StateDB, header *types.Header, tx *types.Transaction, usedGas *uint64,
	cfg vm.Config, extraArgs ...any) (*types.Receipt, error) {
	blockContext := getBlockContext(extraArgs)
