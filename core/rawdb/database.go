	...
	for {
		...
		case <-t.C:
			...
			stats := [][]string{
				...
				{"READ", "HeaderRLP", readHeaderRLPDB.Size(), readHeaderRLPDB.Count()},
				{"WRITE", "HeaderRLP", writeHeaderRLPDB.Size(), writeHeaderRLPDB.Count()},
				{"READ", "BodyRLP", readBodyRLPDB.Size(), readBodyRLPDB.Count()},
				{"READ", "CanonicalBodyRLP", readCanonicalBodyRLPDB.Size(), readCanonicalBodyRLPDB.Count()},
				{"WRITE", "BodyRLP", writeBodyRLPDB.Size(), writeBodyRLPDB.Count()},
				{"READ", "ReceiptsRLP", readReceiptsRLPDB.Size(), readReceiptsRLPDB.Count()},
				{"WRITE", "ReceiptsRLP", writeReceiptsRLPDB.Size(), writeReceiptsRLPDB.Count()},
