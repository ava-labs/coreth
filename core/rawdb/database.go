	...
	for it.Next() {
		...
		default:
			...
			for _, meta := range [][]byte{
				...
				headFinalizedBlockKey, lastPivotKey, snapshotRootKey,
				snapshotBlockHashKey, snapshotGeneratorKey, snapshotRecoveryKey,
				uncleanShutdownKey, badBlockKey, syncRootKey, txIndexTailKey,
