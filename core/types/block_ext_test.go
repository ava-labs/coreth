...
func TestBlockWithNonZeroFields(t *testing.T) {
	...
	t.Run("Block", func(t *testing.T) { allExportedFieldsSet(t, block) })
...
func TestBlockRLP(t *testing.T) {
	...
	input, _ := blockWithNonZeroFields() // the [Block] carries the [BlockBodyExtra] so we can ignore it
	encoded, err := rlp.EncodeToBytes(input)
	require.NoError(t, err, "encode")
	...
	// libevm. WARNING: changing these values can break backwards compatibility
	// with extreme consequences.
	const wantHex = ""
