	...
	tests := []struct {
	...
	}{
		{
			...
			fn: func(db ethdb.Database) (*params.ChainConfig, common.Hash, error) {
				return setupGenesisBlock(db, state.NewDatabaseWithConfig(db, newDbConfig(scheme)), new(Genesis), common.Hash{})
			},
		...
		},
		{
			...
			fn: func(db ethdb.Database) (*params.ChainConfig, common.Hash, error) {
				return setupGenesisBlock(db, state.NewDatabaseWithConfig(db, newDbConfig(scheme)), nil, common.Hash{})
			},
		...
		},
		{
			...
			fn: func(db ethdb.Database) (*params.ChainConfig, common.Hash, error) {
				coredb := state.NewDatabaseWithConfig(db, newDbConfig(scheme))
