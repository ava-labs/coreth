...
var (
	accountReadTimer         = metrics.GetOrRegisterOrOverrideCounter("chain/account/reads", nil)
	accountHashTimer         = metrics.GetOrRegisterOrOverrideCounter("chain/account/hashes", nil)
	accountUpdateTimer       = metrics.GetOrRegisterOrOverrideCounter("chain/account/updates", nil)
	accountCommitTimer       = metrics.GetOrRegisterOrOverrideCounter("chain/account/commits", nil)
	storageReadTimer         = metrics.GetOrRegisterOrOverrideCounter("chain/storage/reads", nil)
	storageHashTimer         = metrics.GetOrRegisterOrOverrideCounter("chain/storage/hashes", nil)
	storageUpdateTimer       = metrics.GetOrRegisterOrOverrideCounter("chain/storage/updates", nil)
	storageCommitTimer       = metrics.GetOrRegisterOrOverrideCounter("chain/storage/commits", nil)
	snapshotAccountReadTimer = metrics.GetOrRegisterOrOverrideCounter("chain/snapshot/account/reads", nil)
	snapshotStorageReadTimer = metrics.GetOrRegisterOrOverrideCounter("chain/snapshot/storage/reads", nil)
	snapshotCommitTimer      = metrics.GetOrRegisterOrOverrideCounter("chain/snapshot/commits", nil)
