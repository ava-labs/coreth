...
func (g Genesis) MarshalJSON() ([]byte, error) {
	type Genesis struct {
		...
		MinDelayExcess *math.HexOrDecimal64                       `json:"minDelayExcess"`
	...
	enc.MinDelayExcess = (*math.HexOrDecimal64)(g.MinDelayExcess)
...
func (g *Genesis) UnmarshalJSON(input []byte) error {
	...
	if dec.MinDelayExcess != nil {
		g.MinDelayExcess = (*uint64)(dec.MinDelayExcess)
	}
	if dec.Number != nil {
