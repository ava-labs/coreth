...
func TestStatefulPrecompile(t *testing.T) {
	...
	tests := []statefulContractTest{
		...
		},
		{
			...
			input:                PackNativeAssetBalanceInput(userAddr1, assetID),
			value:                big0,
			gasInput:             AssetBalanceApricot - 1,
			expectedGasRemaining: 0,
		...
		},
		{
			...
			value:                u256Hundred,
			gasInput:             AssetBalanceApricot,
			expectedGasRemaining: AssetBalanceApricot,
		...
		},
		{
			...
			value:                big0,
			gasInput:             AssetCallApricot + params.CallNewAccountGas,
			expectedGasRemaining: 0,
			expectedErr:          nil,
			expectedResult:       nil,
		...
		},
		{
			...
			gasInput:             AssetCallApricot,
			expectedGasRemaining: AssetCallApricot,
			expectedErr:          vmerrs.ErrInsufficientBalance,
			expectedResult:       nil,
		...
		},
		{
			...
			input:                PackNativeAssetCallInput(userAddr2, assetID, big.NewInt(50), nil),
			value:                uint256.NewInt(50),
			gasInput:             AssetCallApricot + params.CallNewAccountGas - 1,
			expectedGasRemaining: 0,
			expectedErr:          vmerrs.ErrOutOfGas,
			expectedResult:       nil,
		...
		},
		{
			...
			value:                big0,
			gasInput:             AssetCallApricot + params.CallNewAccountGas,
			expectedGasRemaining: AssetCallApricot + params.CallNewAccountGas,
			expectedErr:          vmerrs.ErrExecutionReverted,
			expectedResult:       nil,
