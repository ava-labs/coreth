...
func (t *TestUnsignedTx) Verify(ctx *snow.Context, rules extras.RulesExtra) error { return t.VerifyV }
...
func (t *TestUnsignedTx) SemanticVerify(vm *VM, stx *Tx, parent *Block, baseFee *big.Int, rules extras.RulesExtra) error {
