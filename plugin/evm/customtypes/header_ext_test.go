...
func TestHeaderRLP(t *testing.T) {
	...
	const (
		wantHex     = ""
		wantHashHex = "5e7c662ed48338286a290b3098c86ca6ee767d6deb66f189ddf8e878dbfa49dc"
	)
...
func headerWithNonZeroFields() (*Header, *HeaderExtra) {
	...
	extra := &HeaderExtra{
		...
		TimestampMilliseconds: ptrTo(uint64(123)),
	}
