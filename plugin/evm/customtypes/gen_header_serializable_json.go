...
func (h HeaderSerializable) MarshalJSON() ([]byte, error) {
	type HeaderSerializable struct {
		...
		TimestampMilliseconds *hexutil.Uint64  `json:"timestampMilliseconds" rlp:"optional"`
	...
	enc.TimestampMilliseconds = (*hexutil.Uint64)(h.TimestampMilliseconds)
	enc.Hash = h.Hash()
...
func (h *HeaderSerializable) UnmarshalJSON(input []byte) error {
	...
	if dec.TimestampMilliseconds != nil {
		h.TimestampMilliseconds = (*uint64)(dec.TimestampMilliseconds)
	}
	return nil
}
