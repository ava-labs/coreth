...
func (h HeaderSerializable) MarshalJSON() ([]byte, error) {
	type HeaderSerializable struct {
		...
		TimeMillisecondsPart *hexutil.Uint64  `json:"timeMillisecondsPart" rlp:"optional"`
	...
	enc.TimeMillisecondsPart = (*hexutil.Uint64)(h.TimeMillisecondsPart)
	enc.Hash = h.Hash()
...
func (h *HeaderSerializable) UnmarshalJSON(input []byte) error {
	...
	if dec.TimeMillisecondsPart != nil {
		h.TimeMillisecondsPart = (*uint64)(dec.TimeMillisecondsPart)
	}
	return nil
}
