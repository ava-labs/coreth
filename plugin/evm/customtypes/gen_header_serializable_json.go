...
func (h HeaderSerializable) MarshalJSON() ([]byte, error) {
	type HeaderSerializable struct {
		...
		MinBlockDelayExcess *hexutil.Uint64  `json:"minBlockDelayExcess" rlp:"optional"`
	...
	enc.MinBlockDelayExcess = (*hexutil.Uint64)(h.MinBlockDelayExcess)
	enc.Hash = h.Hash()
...
func (h *HeaderSerializable) UnmarshalJSON(input []byte) error {
	...
	if dec.MinBlockDelayExcess != nil {
		h.MinBlockDelayExcess = (*uint64)(dec.MinBlockDelayExcess)
	}
	return nil
}
