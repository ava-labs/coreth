...
func testConflictingImportTxs(t *testing.T, genesis string) {
	...
	types.HeaderExtras(header).ExtDataGasUsed.Mul(common.Big2, types.HeaderExtras(header).ExtDataGasUsed)
...
func TestEmptyBlock(t *testing.T) {
	...
	if len(types.BlockExtData(emptyEthBlock)) != 0 || types.HeaderExtras(emptyEthBlock.Header()).ExtDataHash != (common.Hash{}) {
