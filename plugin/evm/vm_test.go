...
func setupGenesis(t *testing.T,
	...
	*atomic.Memory) {
	...
	baseDBManager := manager.NewMemDB(version.NewDefaultSemantic(1, 4, 5))
	...
	userKeystore := keystore.New(logging.NoLog{}, manager.NewMemDB(version.NewDefaultSemantic(1, 4, 5)))
