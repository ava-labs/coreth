...
func TestAtomicSyncer(t *testing.T) {
	...
	root, _, _ := syncutils.GenerateTrie(t, serverTrieDB, int(targetHeight), atomicstate.TrieKeyLength)
...
func TestAtomicSyncerResume(t *testing.T) {
	...
	root, _, _ := syncutils.GenerateTrie(t, serverTrieDB, numTrieKeys, atomicstate.TrieKeyLength)
...
func TestAtomicSyncerResumeNewRootCheckpoint(t *testing.T) {
	...
	root1, _, _ := syncutils.GenerateTrie(t, serverTrieDB, numTrieKeys1, atomicstate.TrieKeyLength)
