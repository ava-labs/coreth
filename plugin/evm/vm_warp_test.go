...
func testReceiveWarpMessage(
	...
	getVerifiedWarpMessageTx, err := types.SignTx(getVerifiedWarpMessageTxUnsigned, types.LatestSignerForChainID(vm.chainConfig.ChainID), vmtest.TestKeys[0].ToECDSA())
	require.NoError(err)
