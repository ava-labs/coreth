...
func TestSendWarpMessage(t *testing.T) {
	...
	ethBlock1 := blk.(*chain.BlockWrapper).Block.(extension.VMBlock).GetEthBlock()
...
func testWarpVMTransaction(t *testing.T, unsignedMessage *avalancheWarp.UnsignedMessage, validSignature bool, txPayload []byte) {
	...
	ethBlock := warpBlock.(*chain.BlockWrapper).Block.(extension.VMBlock).GetEthBlock()
...
func testReceiveWarpMessage(
	...
	ethBlock := block2.(*chain.BlockWrapper).Block.(extension.VMBlock).GetEthBlock()
