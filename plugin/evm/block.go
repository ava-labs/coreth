...
var (
	...
	_ snowmanblock.WithVerifyContext = (*Block)(nil)
)
...
func (vm *VM) newBlockImpl(b *Block) atx.BlockWithVerifyContext {
	inner := &blockImpl{Block: b}
	return &atx.BlockImpl{
		BlockWithVerifyContext: inner,
		Txs:                    b.atomicTxs,
		SharedMemoryWriter:     b.sharedMemoryWriter,
		VM:                     vm.VM,
	}
}
...
func (vm *VM) newBlock(ethBlock *types.Block) (*Block, error) {
	...
	impl := vm.newBlockImpl(b)
	b.Block = impl
	b.WithVerifyContext = impl
	return b, nil
}
...
func (b *blockImpl) Accept(context.Context) error {
	vm := b.vm
	...
	if err := b.handlePrecompileAccept(rules, b.sharedMemoryWriter); err != nil {
		return err
	}
	...
	return vm.ctx.SharedMemory.Apply(b.sharedMemoryWriter.requests, vdbBatch)
}
...
func (b *blockImpl) Reject(context.Context) error {
...
func (b *blockImpl) Verify(context.Context) error {
...
func (b *blockImpl) ShouldVerifyWithContext(context.Context) (bool, error) {
